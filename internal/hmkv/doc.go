...
Setup() - This function is called by the main package to setup configuration files. Configuration files store settings for the ripping and encoding process and various other runtime settings.
